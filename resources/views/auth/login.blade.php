                    ...
                    <x-jet-validation-errors class="mb-4" />
                        <form name="frm-login" method="POST" action="{{route('login')}}">
                            ...
                            <fieldset class="wrap-input">
                                ...
                                <input type="password" id="frm-login-pass" name="password" placeholder="************" required autofocus autocomplete="current-password">
                            </fieldset>
                            
                            <fieldset class="wrap-input">
                                <label class="remember-field">
                                    <input class="frm-input " name="remember" id="rememberme" value="forever" type="checkbox" name="remember"><span>Remember me</span>
                                </label>
